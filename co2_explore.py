# -*- coding: utf-8 -*-
"""
Created on Mon Mar 13 09:50:50 2023
...
if __name__ == "__main__":
    app.run_server(debug = True) #Needs to be true, to have it constantly updated #Want to be able to update it - is under developmnet.
